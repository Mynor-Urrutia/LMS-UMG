...
import { EVALUATION_REPOSITORY, IEvaluationRepository, AttemptWithStudentInfo } from '../../domain/ports/evaluation-repository.port';
...
export class ListAttemptsUseCase {
  ...
  async execute(
    ...
    actorId: string,
    actorRole: UserRole,
  ): Promise<AttemptWithStudentInfo[]> {
    ...
    return this.evalRepo.findAttemptsByEvaluation(evaluationId);
  }
}
